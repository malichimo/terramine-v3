    ...
    <View style={st.screen}>
      ...
      <ScrollView contentContainerStyle={st.menuBody}>
        ...
        <View style={st.box}>
          ...
          <View style={st.row}><Text style={st.rIco}>🔦</Text><Text style={st.rTxt}>Headlamp Boost – wide cone for {BOOST_DUR}s (1 free)</Text></View>
          <View style={st.row}><Text style={st.rIco}>🐦</Text><Text style={st.rTxt}>Canary – warns when hazards within {CANARY_DIST} cells</Text></View>
      ...
      <View style={st.ctrlWrap}>
        ...
        <View style={st.pRow}>
          <TouchableOpacity style={[st.pBtn,(pu.charges<=0||pu.boosted)&&st.pDim]}
            ...
            <Text style={st.pLbl}>Boost ({pu.charges})</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={[st.pBtn, pu.canary && st.pOn]} onPress={adCanary} disabled={pu.canary}>
            <Text style={st.pIco}>🐦</Text>
            <Text style={st.pLbl}>{pu.canary ? 'Active' : 'Canary'}</Text>
          </TouchableOpacity>
